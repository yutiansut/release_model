...
class Strapro : public alpha {
   ...
   private:
    ...
    hft::fast::L2p1 L2p1_caler;
    hft::fast::L2p2 L2p2_caler;
    hft::fast::VOI VOI_caler;
    hft::fast::a1f10 a1f10_caler;
    hft::fast::a1f11 a1f11_caler;
    hft::fast::rank_1 rank1_caler;
    hft::fast::rank_2 rank2_caler;
...
Strapro::Strapro()
    : alpha(),
      ...
      IH2_data{"IH2", min_ticks},
      IC1_factor_data{"IC1", min_ticks} {
    this->init_data();
